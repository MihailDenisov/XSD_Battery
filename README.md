...
- **INA180A3IDBVR** (DA5) измеряет ток в цепи выходных 5.5 В через шунт **R14 (0.18 Ом, LR2512-21R180F4)**, усиленный сигнал через RC-фильтр подаётся на вход АЦП ATtiny10 (PB0/ADC0).
...
- [ ] Разработка 3D-модели корпуса, пригодного для печати на 3D-принтере.

## Структура репозитория

```
/XDS_Batt_files/              — изображения платы и схемы (используются в этом README)
  XDS_PCB_Top.JPG
  XDS_PCB_bottom.JPG
  XDS_Schematic.JPG
